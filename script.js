const conselhos =
[
    "Acredito em você mesmo.", "O primeiro passo é o mais importante.",
...
const novoconselhoBtn = document.getElementById('novo conselhoBtn');

function gerarConselho() {
    //BUG INTENCIONAL AQUI 
    const indice = Math.floor(Math.random() * (conselhos.legth + 1));
